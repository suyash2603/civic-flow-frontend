      ...
      <div className="flex-1 flex items-center justify-center p-4">
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            <div className="bg-amber-700 p-4 rounded-2xl w-fit mx-auto mb-4">
          ...
          <div className="mt-6 text-center space-y-2">
            <button
              ...
              data-testid="link-surveyor-login"
            >
              Surveyor Login
            </button>
            <button
          ...
          <div className="mt-8 p-4 bg-amber-50 border border-amber-200 rounded-xl">
            <p className="text-xs text-amber-900 font-medium mb-2">Demo Credentials:</p>
            <p className="text-xs text-amber-700">Email: admin@gov.in</p>
